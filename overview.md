...
*   файл <i>job.conf</i> - это файл конфигурации задачи, если его нет, то мы не считаем этот подкаталог задачей, <b>в этом файле обязательно должна быть задана как минимум переменная _script_="имя файла скрипта" для запуска задачи</b>
