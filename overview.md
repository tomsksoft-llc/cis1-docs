...
*   файл _job.conf_ - это файл конфигурации задачи, если его нет, то мы не считаем этот подкаталог задачей
+   в этом файле обязательно должна быть задана как минимум переменная _script_="имя файла скрипта" для запуска задачи
+   остальные параметры, задаваемые этим файлом см. ниже
