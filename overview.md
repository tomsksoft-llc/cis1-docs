...
Для запуска задачи используем команду системы _$cis_base_dir/core/$startjob_ с параметром проект/задача:
...
Чтение переменной сессии:  _$cis_base_dir/core/$setvalue <name>_, значение переменной будет выдано на стандартный выход:
